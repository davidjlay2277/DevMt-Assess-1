...
//Print the steps in the correct sequence, simiar to Problem 1, but now with the descriptions
console.log("\nPROBLEM 2:");
...
//Print a new SDLC list htat includes the name of hte step follow by the description.